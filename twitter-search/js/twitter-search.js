...
function set_option_values() {
    ...
    option_values['check-search_keyword'] = check_search_keyword.value;
    option_values['only_keywords'] = check_only_keywords.value;
    option_values['autdor_id'] = input_autdor_id.value;
    option_values['check-autdor_id'] = check_autdor_id.value;
    option_values['exclude_keyword'] = input_exclude_keyword.value;
    option_values['check-exclude_keyword'] = check_exclude_keyword.value;
    option_values['exclude_autdor_id'] = input_exclude_autdor_id.value;
    option_values['check-exclude_autdor_id'] = check_exclude_autdor_id.value;
    option_values['included_url'] = input_included_url.value;
    option_values['check-included_url'] = check_included_url.value;
    option_values['replies'] = input_replies.value;
    option_values['check-replies'] = check_replies.value;
    ...
    option_values['check-since_date'] = check_since_date.value;
    option_values['until_date'] = input_until_date.value;
    option_values['check-until_date'] = check_until_date.value;
    option_values['lang'] = select_lang.value;
    option_values['check-lang'] = check_lang.value;
...
function load() {
    ...
    for (var i = 0; i < presets_array.length; i++) {
        if (presets_array[i]['preset_name'] == preset_name) {
            ...
            check_search_keyword.value = option_values['check-search_keyword'];
            check_only_keywords.value = option_values['only_keywords'];
            input_autdor_id.value = option_values['autdor_id'];
            check_autdor_id.value = option_values['check-autdor_id'];
            input_exclude_keyword.value = option_values['exclude_keyword'];
            check_exclude_keyword.value = option_values['check-exclude_keyword'];
            input_exclude_autdor_id.value = option_values['exclude_autdor_id'];
            check_exclude_autdor_id.value = option_values['check-exclude_autdor_id'];
            input_included_url.value = option_values['included_url'];
            check_included_url.value = option_values['check-included_url'];
            input_replies.value = option_values['replies'];
            check_replies.value = option_values['check-replies'];
            ...
            check_since_date.value = option_values['check-since_date'];
            input_until_date.value = option_values['until_date'];
            check_until_date.value = option_values['check-until_date'];
            select_lang.value = option_values['lang'];
            check_lang.value = option_values['check-lang'];
